( function( $ ) {
    ...
    $( ".wheel_button input[type=submit]" ).click(function( event ) {
        $('.wheel__inner').addClass('wheelAnimation');
        setTimeout(function(){
            $('.wheel__inner').removeClass('wheelAnimation');
        }, 3000);
     });
