( function( $ ) {
    ...
    '{"type": "debuff","name": "Смотровик","pic": "steamrandom.png","description": "следующие 5 видосов на перерыве будут не скипабельными, кроме осуждающего контента. (одноразово)"},'+
    '{"type": "debuff","name": "Минимальные настройки","pic": "intershariki.png","description": "на 20? минут у стримера включается минимальные настройки + разрешение в игре. (одноразово)"}]';
    ;
