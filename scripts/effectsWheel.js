( function( $ ) {
    ...
    '{"type": "buff","name": "Испорченный телефон","pic": "telefon.png","description": "стример играет в испорченный телефон с сабами.(можно использовать для перерыва)"},'+
    ...
    '{"type": "buff","name": "Алиас","pic": "alias.png","description": "стример играет в алиас с сабами. (пару партий)"},'+
