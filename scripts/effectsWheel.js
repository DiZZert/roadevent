( function( $ ) {
    ...
    '{"type": "debuff","name": "планета Миллер","pic": "plus1hour.png","description": "+30 минут к текущей игре"},'+
    '{"type": "debuff","name": "Музон","pic": "gachitime.png","description": "включается мубот"},'+
    ...
    '{"type": "debuff","name": "Дегустатор","pic": "degustator.png","description": "стример должен попробовать одну запасную игру на выбор, минимум 20 минут, потом может офать, но за каждые 5 минут до стандартного часа дарит сабку"},'+
    ...
    var legendaryArray = [
      "кинодень",
      "выбор со зрителями онлайн игры из топа твича и стрим по ней",
      // "чил дэй с кс/дотой/настолкой/гвинтом и т.д. на следующем стриме",
      "cтрим видосов от зрителей",
      // "коллаб с другим стримером на одном из следующих стримов",
      "зацепный стрим по игре с сабдея, которую выберут зрители",
